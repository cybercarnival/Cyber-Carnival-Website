...
{/* next gallery */}
    <div className='flex flex-col justify-center items-center mt-8'>
        <h1 className='text-8xl font-semibold bg-gradient-to-r from-green-400 to-teal-400 text-transparent bg-clip-text p-2'>Cyber Awareness</h1>
        {/* <p className='text-center w-2/3'>The Cyber Carnival at SRM Ramapuram is an electrifying event hosted by the cybersecurity department, promising an immersive journey into the world of digital defense and innovation.</p> */}
      </div>
       <Swiper
      // install Swiper modules
    ...
    {/* next gallery */}
    <div className='flex flex-col justify-center items-center mt-8'>
        <h1 className='text-8xl font-semibold bg-gradient-to-r from-green-400 to-teal-400 text-transparent bg-clip-text p-2'>Cyberthon</h1>
        {/* <p className='text-center w-2/3'>The Cyber Carnival at SRM Ramapuram is an electrifying event hosted by the cybersecurity department, promising an immersive journey into the world of digital defense and innovation.</p> */}
      </div>
       <Swiper
      // install Swiper modules
    ...
    {/* next gallery */}
    <div className='flex flex-col justify-center items-center mt-8'>
        <h1 className='text-8xl font-semibold bg-gradient-to-r from-green-400 to-teal-400 text-transparent bg-clip-text p-2'>Cyber Conclave</h1>
        {/* <p className='text-center w-2/3'>The Cyber Carnival at SRM Ramapuram is an electrifying event hosted by the cybersecurity department, promising an immersive journey into the world of digital defense and innovation.</p> */}
      </div>
       <Swiper
      // install Swiper modules
