...
import cyberCarnivalPng from '../../assets/bg_logo.png';
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:mb-44 items-center">
          ...
          <div className="relative flex flex-col items-center space-y-8">
            ...
            <img src={imageSrc} alt={title} className={` ${title=="Cyber Carnival"?"w-1/2":title=='SRMIST'?"w-1/2":"w-3/4"}   h-auto justify-self-center`} />
  ...
  return (
    <section className="relative w-full mx-auto -mt-16 py-12 px-4 overflow-hidden ">
      ...
      <div className="relative mb-40 z-10">
        ...
        {createSection(computerCyber, " CSE Cyber Security ", 
